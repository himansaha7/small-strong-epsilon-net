# epsilon-net of size 3 for disk
    ...
    for j in range(0, N):
        for k in range(j + 1, N):
            for l in range(k + 1, N):
                ...
                regions = [[[circle() for n in range(0, N)] for m in range(0, N)] for o in range(0, N)]
                    ...
                    for b in range(a + 1, N):
                        for c in range(b + 1, N):
                            ...
                            if collinear(points[a][0], points[a][1], points[b][0], points[b][1], points[c][0], points[c][1]) == "no":
                                ...
                                if locPointWrtCircle(points[j], regions[a][b][c]) != "inside" and locPointWrtCircle(points[k], regions[a][b][c]) != "inside" and locPointWrtCircle(points[l], regions[a][b][c]) != "inside":
                                    regions[a][b][c].status = "consider"
                # count = 1
